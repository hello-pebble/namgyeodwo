export default function About() {
  return <article className="content-page">
    ...
    <section className="content-card"><h2>배운 것도 같은 습관으로</h2><p>쇼츠에서 본 팁, 책에서 읽은 한 줄, 강의에서 들은 결론. 있었던 일과 구분해 ‘배운 것’으로 남기면 AI가 출처·핵심 주장·기억할 포인트·태그로 정리합니다. 입력이 배운 내용에 가까우면 먼저 제안하기도 해요. 쌓인 배운 것은 주제와 태그로 다시 찾을 수 있습니다.</p></section>
